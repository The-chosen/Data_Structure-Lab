...
import com.example.yy.algorithm_lab.Algorithm.collections.KMP;
...
import com.example.yy.algorithm_lab.Android.db.Publish;
import com.example.yy.algorithm_lab.Android.db.Site;
import com.example.yy.algorithm_lab.Algorithm.sys.Dijkstra;
import com.example.yy.algorithm_lab.Algorithm.sys.Hamilton;
import com.example.yy.algorithm_lab.Algorithm.sys.SiteGraph;
import com.example.yy.algorithm_lab.Algorithm.sys.parkingLot;
...
//    导游路线图
    public static String guidline(String from, String to) {
        ...
        Hamilton hamilton = new Hamilton(siteGraph, begin, end, begin == end);
